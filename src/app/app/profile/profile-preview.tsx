...
export default function ProfilePreview({
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-[450px] p-6 size-full bg-linear-to-br from-zinc-50/50 to-zinc-100/50 dark:from-zinc-950/20 dark:to-zinc-900/20 relative">
      {/* View Toggle */}
          ...
          <div className="p-5 flex-1 grid grid-cols-12 gap-5 min-h-0 overflow-y-auto scrollbar-none">
            ...
            <div className="col-span-5 flex flex-col justify-center items-center bg-foreground/3 border border-foreground/5 p-4 rounded-2xl h-fit my-auto">
              <div className="text-center mb-3">
                <span className="text-[9px] uppercase font-bold tracking-wider opacity-45">Support Streamer</span>
                <p className="text-[10px] text-foreground/60 mt-1 leading-snug">Send a tip to show your appreciation!</p>
              </div>
              <button
                disabled
                style={{ backgroundColor: accentHex, color: accentForegroundHex }}
