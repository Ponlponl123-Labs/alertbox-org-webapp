    ...
    <AnimatePresence>
      {isBackendAlive === false && (
        <motion.div
          ...
          className="fixed top-0 left-0 right-0 w-full bg-linear-to-r from-rose-950/40 via-amber-950/40 to-rose-950/40 border-b border-rose-500/20 backdrop-blur-xl z-[999] py-2.5 px-4 flex items-center justify-center gap-3 shadow-lg select-none"
        >
          {/* Blinking status dot */}
          ...
          <WarningIcon className="text-rose-400 size-4 animate-pulse" weight="fill" />
