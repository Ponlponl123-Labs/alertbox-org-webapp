  ...
  return (
    <>
        ...
        <main className="flex flex-1 w-full max-w-5xl flex-col items-center justify-between py-32 px-16 sm:items-start z-10">
          ...
          <div className="flex gap-6">
            <div className="flex flex-col items-center gap-6 text-center sm:items-start sm:text-left">
              <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-zinc-100 dark:bg-zinc-900 border border-zinc-200/65 dark:border-zinc-800/65 mb-4 self-center sm:self-start">
          ...
          <div className="flex flex-col gap-4 text-base font-medium sm:flex-row w-full items-center">
            <BorderGlow
              ...
              className="min-w-0 max-w-106 max-md:min-w-88 flex-1 rounded-full p-[1px] bg-zinc-100/50 dark:bg-zinc-900/50 backdrop-blur-sm"
            >
              <Input
                type="text"
                startContent={
      ...
      >
        <div className="sticky top-12 mt-16 -mb-16 flex flex-col items-center">
          ...
          <BorderGlow
            ...
            glowIntensity={0.6}
            colors={["#EAB308", "#38bdf8", "#ec4899"]}
            className="mt-6 bg-foreground/5 p-[1px] rounded-full"
          >
      ...
      <section className="w-full bg-zinc-50 dark:bg-black font-sans py-24 border-t border-zinc-100 dark:border-zinc-900 relative overflow-hidden">
        ...
        <div className="w-full absolute top-0 left-0 h-full pointer-events-none overflow-hidden z-0">
          <div className="w-full absolute top-[20%] left-0 h-[600px] mask-b-from-60%">
            <LightRays
        ...
        <div className="max-w-5xl mx-auto px-6 lg:px-8 z-10 relative">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {[
              ...
              <BorderGlow
                ...
                backgroundColor="var(--bg-card)"
                className="flex flex-col gap-4 p-6 rounded-2xl bg-zinc-50 dark:bg-zinc-950 border border-zinc-100 dark:border-zinc-900"
              >
